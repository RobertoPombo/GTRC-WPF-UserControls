...
namespace GTRC_WPF_UserControls.ViewModels
{
    public class DiscordBotConfigVM : ObservableObject
    {
        ...
        public static event Notify? ConfirmDiscordBotActivated;

        public static void OnConfirmDiscordBotActivated() { ConfirmDiscordBotActivated?.Invoke(); }
